...
export const BUILDING_ROOMS = {
  ...
  // Single-storey long strip running east–west.
  // =========================================================================
  'UTL-01': {
    // Ground floor rooms + mezzanine levels share the same visual layout
    default: [
      { code: 'MVC', label: 'MV Corridor',         x1: 0.00, y1: 0.00, x2: 0.26, y2: 0.32, fill: T.mv   },
      { code: 'LVR', label: 'LV Room',             x1: 0.00, y1: 0.32, x2: 0.26, y2: 0.72, fill: T.lv   },
      { code: 'STR', label: 'Safety TR Room',      x1: 0.00, y1: 0.72, x2: 0.14, y2: 1.00, fill: T.mv   },
      { code: 'CRR', label: 'Corner Reserve',      x1: 0.14, y1: 0.72, x2: 0.26, y2: 1.00, fill: T.util },
      { code: 'UPS', label: 'UPS Room',            x1: 0.26, y1: 0.00, x2: 0.43, y2: 0.50, fill: T.ctrl },
      { code: 'UTR', label: 'Utilities Tech Rm',   x1: 0.26, y1: 0.50, x2: 0.43, y2: 1.00, fill: T.util },
      { code: 'UTW', label: 'Utilities Workshop',  x1: 0.43, y1: 0.00, x2: 0.60, y2: 1.00, fill: T.util },
      { code: 'CPH', label: 'Compressor Hall',     x1: 0.60, y1: 0.00, x2: 0.84, y2: 1.00, fill: T.mech },
      { code: 'CPR', label: 'Compressor Panel Rm', x1: 0.66, y1: 0.55, x2: 0.84, y2: 1.00, fill: T.lv   },
      { code: 'GSR', label: 'Generator Sync Rm',   x1: 0.84, y1: 0.00, x2: 1.00, y2: 1.00, fill: T.mech },
    ],
  },
  ...
  'BTH-03': {
    ...
    // Level 5 (5.1 m): silo mid-section + dosing equipment
    'Level 5': [
    ...
    // Level 12 (12 m): control room + upper silo heads
    'Level 12': [
    ...
    // Upper floors (17 m, 22 m, 27 m, 32 m): open silo space
    'Level 17': [
